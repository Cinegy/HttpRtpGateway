...
namespace HttpRtpGateway
{
    internal class Options
    {
        ...
        [Option('e', "elasticsearchurl", Required = false, Default = "https://telemetry.cinegy.com/",
        ...
        [Option('o', "organisation", Required = false, Default = "AMWA",
        HelpText = "Text value to use for telemetry filtering - should be set to an Organisation value you are a member of!")]
    ...
    internal class StreamOptions : Options
    {
        ...
        [Option('b', "buffertime", Required = false, Default = 1000,
        HelpText = "Time (in milliseconds) to hold in buffer.")]
